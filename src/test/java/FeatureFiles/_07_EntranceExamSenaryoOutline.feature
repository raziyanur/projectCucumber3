...
Feature: Entrance Exam Functionality
  ...
  Scenario Outline: Create and Delete a Exam
    ...
    Examples:
      | ExamName      | AcademicPeriodOption | GradeLevelOption |
      | Mat exam i11  | academicPeriod1      | gradeLevel2      |
      | uni exam i11  | academicPeriod1      | gradeLevel2      |
      | bgg exam i11  | academicPeriod1      | gradeLevel2      |
      | fiz exam  i11 | academicPeriod1      | gradeLevel2      |
